...
- Grace(8644): 已停用 — 企微WebSocket死循环根因未解决，暂停服务
...
- 小亚/柏拉图持有agent token，拥有信号写入+任务读取+状态查询权限
...
```json
{"agent":"plato","ts":"2026-05-25T07:24:52Z","status":"degraded","gw":"online(200,3.2s)","proc":"cpu=0.8%","task":"review-arch-v2(in_progress)","alert":"ttfb_degraded"}
```
